...
// D Block Entrance (Converted from { x: 400, y: 300 })
const dBlockEntrance = { x: 48.78, y: 71.43 };

const dBlockGroundRooms = [
  { id: "washroom", name: "Washroom", x: 6.1, y: 11.9, w: 12.2, h: 14.29, path: [[400, 280], [400, 230], [100, 230], [100, 120]] },
  { id: "avhall", name: "AV Hall", x: 19.51, y: 11.9, w: 24.39, h: 35.71, path: [[400, 280], [400, 250], [260, 250], [260, 210]] },
  { id: "stairs", name: "Stairs ", x: 45.12, y: 11.9, w: 4.88, h: 23.81, path: [[390, 160], [390, 280]] },
  { id: "dl001", name: "DL-001", x: 51.22, y: 11.9, w: 9.76, h: 19.05, path: [[400, 280], [400, 180], [460, 180], [460, 140]] },
  { id: "dl002", name: "DL-002", x: 63.41, y: 11.9, w: 9.76, h: 23.81, path: [[400, 280], [400, 180], [560, 180], [560, 160],] },
  { id: "dl003", name: "DL-003", x: 75.61, y: 11.9, w: 9.76, h: 19.05, path: [[400, 280], [400, 180], [660, 180], [660, 140]] },
  { id: "dl005", name: "DL-005", x: 87.8, y: 11.9, w: 9.76, h: 19.05, path: [[400, 280], [400, 180], [760, 180], [760, 140]] },
  { id: "meeting", name: "Meeting Room", x: 6.1, y: 66.67, w: 24.39, h: 19.05, path: [[400, 280], [400, 250], [200, 250], [200, 275]] },
  { id: "dl004", name: "DL-004", x: 82.93, y: 47.62, w: 14.63, h: 19.05, path: [[400, 280], [400, 180], [745, 180], [745, 195]] },
];

// First floor (aligned right-side like ground)
// These look like they were centered or scaled differently, I will re-calculate based on a 820x420 canvas.
const dBlockFirstRooms = [
  { id: "washroom1", name: "Washroom", x: 69.51, y: 71.43, w: 12.2, h: 14.29, path: [[300, 260], [300, 150], [620, 150], [620, 295]] },
  { id: "avhall1", name: "AV Hall", x: 42.68, y: 50, w: 24.39, h: 35.71, path: [[300, 260], [300, 150], [450, 150], [450, 205]] },
  { id: "aimlstaff", name: "AIML Staffroom", x: 6.1, y: 19.05, w: 24.39, h: 71.43, path: [[300, 260], [300, 210], [220, 210], [220, 240]] },
  { id: "stairs1", name: "Stairs ", x: 32.93, y: 61.9, w: 7.32, h: 23.81, path: [[300, 260], [300, 240], [320, 240], [320, 320]] },
  { id: "aimlhod", name: "AIML HOD Cabin", x: 23.17, y: 19.05, w: 7.32, h: 14.29, path: [[300, 260], [300, 210], [180, 210], [180, 160], [220, 160], [220, 150]] },
];

const dBlockSecondRooms = [
  { id: "me201", name: "ME 201", x: 6.1, y: 38.1, w: 14.63, h: 21.43, path: [[300, 270], [300, 210], [180, 210]] },
  { id: "me205", name: "ME 205", x: 60.98, y: 11.9, w: 14.63, h: 21.43, path: [[300, 270], [300, 200], [580, 200], [580, 150]] },
  { id: "me204", name: "ME 204", x: 43.9, y: 11.9, w: 14.63, h: 21.43, path: [[300, 270], [300, 200], [380, 200], [380, 150]] },
  { id: "me203", name: "ME 203", x: 26.83, y: 11.9, w: 14.63, h: 21.43, path: [[300, 270], [300, 150]] },
  { id: "me202", name: "ME 202", x: 9.76, y: 11.9, w: 14.63, h: 21.43, path: [[300, 270], [300, 170], [190, 170], [190, 150]] },
  { id: "innovation", name: "Innovation & Entrepreneurship Cell", x: 6.1, y: 64.29, w: 24.39, h: 23.81, path: [[300, 270], [300, 250], [200, 250], [200, 270]] },
  { id: "stairs2", name: "Stairs ", x: 32.93, y: 64.29, w: 7.32, h: 23.81, path: [[300, 270], [300, 250], [320, 250], [320, 335]] },
  { id: "washroom1", name: "Washroom", x: 69.51, y: 76.19, w: 12.2, h: 14.29, path: [[300, 270], [300, 230], [620, 230], [620, 315]] },
  { id: "avhall1", name: "AV Hall", x: 42.68, y: 64.29, w: 24.39, h: 30.95, path: [[300, 270], [300, 230], [450, 230], [450, 265]] },
];

const dBlockThirdRooms = [
  { id: "cv302", name: "CV 302", x: 50, y: 11.9, w: 14.63, h: 21.43, path: [[300, 270], [300, 200], [450, 200], [450, 150]] },
  { id: "cv301", name: "CV 301", x: 32.93, y: 11.9, w: 14.63, h: 21.43, path: [[300, 270], [300, 150]] },
  { id: "cv303", name: "CV 303", x: 67.07, y: 11.9, w: 14.63, h: 21.43, path: [[300, 270], [300, 200], [600, 200], [600, 150]] },
  { id: "aidsstaffroom", name: "AIDS Staffroom", x: 6.1, y: 42.86, w: 24.39, h: 52.38, path: [[300, 270], [300, 250], [250, 250]] },
  { id: "stairs3", name: "Stairs ", x: 32.93, y: 64.29, w: 7.32, h: 23.81, path: [[300, 270], [300, 250], [320, 250], [320, 335]] },
  { id: "washroom", name: "Washroom", x: 69.51, y: 76.19, w: 12.2, h: 14.29, path: [[300, 270], [300, 230], [620, 230], [620, 315]] },
  { id: "avhall", name: "AV Hall", x: 42.68, y: 64.29, w: 24.39, h: 30.95, path: [[300, 270], [300, 230], [450, 230], [450, 265]] },
];

const dBlockFourthRooms = [
  { id: "cv400", name: "CV 400", x: 6.1, y: 38.1, w: 14.63, h: 21.43, path: [[300, 270], [300, 200], [180, 200]] },
  { id: "cv404", name: "CV 404", x: 64.63, y: 11.9, w: 14.63, h: 21.43, path: [[300, 270], [300, 200], [580, 200], [580, 150]] },
  { id: "cv403", name: "CV 403", x: 46.34, y: 11.9, w: 14.63, h: 21.43, path: [[300, 270], [300, 200], [400, 200], [400, 150]] },
  { id: "cv402", name: "CV 402", x: 28.05, y: 11.9, w: 14.63, h: 21.43, path: [[300, 270], [300, 150]] },
  { id: "cv401", name: "CV 401", x: 9.76, y: 11.9, w: 14.63, h: 21.43, path: [[300, 270], [300, 170], [190, 170], [190, 150]] },
  { id: "imagecell", name: "Image and Video Analytics Cell", x: 6.1, y: 64.29, w: 24.39, h: 30.95, path: [[300, 270], [300, 250], [200, 250], [200, 265]] },
  { id: "stairs4", name: "Stairs ", x: 32.93, y: 64.29, w: 7.32, h: 23.81, path: [[300, 270], [300, 250], [320, 250], [320, 335]] },
  { id: "washroom", name: "Washroom", x: 69.51, y: 76.19, w: 12.2, h: 14.29, path: [[300, 270], [300, 230], [620, 230], [620, 315]] },
  { id: "avhall", name: "AV Hall", x: 42.68, y: 64.29, w: 24.39, h: 30.95, path: [[300, 270], [300, 230], [450, 230], [450, 265]] },
];
        ...
        <style>
          ...
          .react-chatbot-kit-chat-input {
            ...
            .react-chatbot-kit-chat-input-container {
              /* This targets the surrounding wrapper which often handles the bottom bar */
              background-color: #0b0b0b !important;
              border-top: 1px solid rgba(210, 192, 192, 0.7) !important; /* Optional: adds a dark separator line */
          }

          .react-chatbot-kit-chat-message-container {
              /* If the background around the messages is still white */
